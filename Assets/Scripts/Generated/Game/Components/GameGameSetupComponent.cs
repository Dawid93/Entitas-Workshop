...
public partial class GameContext {
    ...
    public GameEntity SetGameSetup(EntitasTest.GameSetup newValue) {
        if (hasGameSetup) {
    ...
    public void ReplaceGameSetup(EntitasTest.GameSetup newValue) {
...
public partial class GameEntity {
    ...
    public void AddGameSetup(EntitasTest.GameSetup newValue) {
